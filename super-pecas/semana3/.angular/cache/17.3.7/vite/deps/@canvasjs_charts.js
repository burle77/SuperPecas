...
var require_canvasjs_min = __commonJS({
  "node_modules/@canvasjs/charts/canvasjs.min.js"(exports, module) {
    (function() {
      ...
      function Aa(d) {
        d.roundRect = function(d2, S, p2, v2, sa, D, t2, A2) {
          ...
          this.beginPath();
          this.moveTo(d2 + sa, S);
          this.lineTo(d2 + p2 - sa, S);
          this.quadraticCurveTo(d2 + p2, S, d2 + p2, S + sa);
          this.lineTo(d2 + p2, S + v2 - sa);
          this.quadraticCurveTo(d2 + p2, S + v2, d2 + p2 - sa, S + v2);
      ...
      function fb(d, l) {
        var S = this.length >>> 0, p2 = Number(l) || 0, p2 = 0 > p2 ? Math.ceil(p2) : Math.floor(p2);
        for (0 > p2 && (p2 += S); p2 < S; p2++)
      ...
      function $a(d, l, p2) {
        ...
        if (isNaN($)) {
          try {
            ...
            ya.style.display = "";
            L(ya, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: d, fontSize: l + "px", fontWeight: p2 });
      ...
      function ib(d) {
        ...
        if (d.exportEnabled && d._dropdownMenu) {
          ...
          for (var p2 = d._dropdownMenu.childNodes, V = [d._cultureInfo.printText, d._cultureInfo.saveJPGText, d._cultureInfo.savePNGText], $ = 0; $ < V.length; $++)
            L(p2[$], { backgroundColor: d.toolbar.itemBackgroundColor, color: d.toolbar.fontColor }), p2[$].innerHTML = V[$];
        } else
          !d._dropdownMenu && (d.exportEnabled && v) && (l = false, d._dropdownMenu = document.createElement("div"), d._dropdownMenu.setAttribute("tabindex", -1), p2 = d.theme && -1 !== d.theme.indexOf("dark") ? "black" : "#888888", L(d._dropdownMenu, { position: "absolute", zIndex: 1, userSelect: "none", MozUserSeelct: "none", WebkitUserSelect: "none", msUserSelect: "none", cursor: "pointer", right: "0px", top: "25px", minWidth: "120px", outline: 0, fontSize: "14px", fontFamily: "Arial, Helvetica, sans-serif", padding: "5px 0px 5px 0px", textAlign: "left", lineHeight: "10px", backgroundColor: d.toolbar.itemBackgroundColor, boxShadow: "2px 2px 10px " + p2 }), d._dropdownMenu.style.display = "none", d._toolBar.appendChild(d._dropdownMenu), J(
            d._dropdownMenu,
            "blur",
            function() {
              xa(d._dropdownMenu);
            ...
            d.allDOMEventHandlers,
            true
          ), p2 = document.createElement("div"), L(p2, { padding: "12px 8px 12px 8px" }), p2.innerHTML = d._cultureInfo.printText, p2.style.backgroundColor = d.toolbar.itemBackgroundColor, p2.style.color = d.toolbar.fontColor, d._dropdownMenu.appendChild(p2), J(p2, "touchstart", function(d2) {
            l = true;
            ...
            d.allDOMEventHandlers,
            true
          ), J(p2, "mouseout", function() {
            l || (this.style.backgroundColor = d.toolbar.itemBackgroundColor, this.style.color = d.toolbar.fontColor);
          }, d.allDOMEventHandlers, true), J(p2, "click", function() {
            d.print();
            xa(d._dropdownMenu);
          }, d.allDOMEventHandlers, true), p2 = document.createElement("div"), L(p2, { padding: "12px 8px 12px 8px" }), p2.innerHTML = d._cultureInfo.saveJPGText, p2.style.backgroundColor = d.toolbar.itemBackgroundColor, p2.style.color = d.toolbar.fontColor, d._dropdownMenu.appendChild(p2), J(p2, "touchstart", function(d2) {
            l = true;
          }, d.allDOMEventHandlers), J(p2, "mousemove", function() {
            l || (this.style.backgroundColor = d.toolbar.itemBackgroundColorOnHover, this.style.color = d.toolbar.fontColorOnHover);
          }, d.allDOMEventHandlers, true), J(p2, "mouseout", function() {
            l || (this.style.backgroundColor = d.toolbar.itemBackgroundColor, this.style.color = d.toolbar.fontColor);
          }, d.allDOMEventHandlers, true), J(p2, "click", function() {
            d.exportChart({ format: "jpeg", fileName: d.exportFileName });
            xa(d._dropdownMenu);
          }, d.allDOMEventHandlers, true), p2 = document.createElement("div"), L(p2, { padding: "12px 8px 12px 8px" }), p2.innerHTML = d._cultureInfo.savePNGText, p2.style.backgroundColor = d.toolbar.itemBackgroundColor, p2.style.color = d.toolbar.fontColor, d._dropdownMenu.appendChild(p2), J(p2, "touchstart", function(d2) {
            l = true;
          }, d.allDOMEventHandlers), J(p2, "mousemove", function() {
            l || (this.style.backgroundColor = d.toolbar.itemBackgroundColorOnHover, this.style.color = d.toolbar.fontColorOnHover);
          }, d.allDOMEventHandlers, true), J(p2, "mouseout", function() {
      ...
      function ta(d, l, p2) {
        ...
        l.getAttribute("state") !== p2 && (l.setAttribute("state", p2), l.setAttribute("type", "button"), L(l, {
          padding: "5px 12px",
          cursor: "pointer",
          "float": "left",
          width: "40px",
          ...
          lineHeight: "0"
        }), l.innerHTML = "<img src='" + lb[p2].image + "' alt='" + d._cultureInfo[p2 + "Text"] + "' />", L(l.childNodes[0], { height: "95%", pointerEvents: "none" }));
      ...
      var hb = function() {
        ...
        return function(A2, H2, P) {
          var R2 = P ? P.days : l, O2 = P ? P.months : v2, J2 = P ? P.shortDays : p2, T2 = P ? P.shortMonths : $;
          P = "";
          var L2 = false;
        ...
        l = String(l);
        var D = 1, A2 = p2 = "", H2 = -1, P = [], R2 = [], O2 = 0, L2 = 0, J2 = 0, T2 = false, Z2 = 0, A2 = l.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        l = null;
            ...
            if (H2++, H2 === O2) {
              ...
              if ("0" === l)
                for (l = O2 - L2 - (Y ? Y.length : 0); 0 < l; )
                  Y.unshift("0"), l--;
              for (; 0 < Y.length; )
                p2 = Y.pop() + p2, T2++, 0 === T2 % A2 && (N === J2 && 0 < Y.length) && (p2 = t2 + p2);
            } else
              0 < D.length ? (p2 = D.pop() + p2, L2++, T2++) : "0" === l && (p2 = "0" + p2, L2++, T2++), 0 === T2 % A2 && (N === J2 && 0 < D.length) && (p2 = t2 + p2);
          else
            "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (N++, A2 = T2, T2 = 0, 0 < D.length && (p2 = t2 + p2)) : p2 = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + p2 : l + p2 : (l = 0 > Z2 ? l.replace(
              "+",
              ""
        ...
        return { x: l, y: p2 };
      }, cb = true, Ua = window.devicePixelRatio || 1, Oa = 1, ma = cb ? Ua / Oa : 1, ba = function(d, l, p2, v2, t2, A2, D, H2, T2, P, O2, R2, L2) {
        "undefined" === typeof L2 && (L2 = 1);
        D = D || 0;
        H2 = H2 || "black";
        var J2 = 15 < v2 - l && 15 < t2 - p2 ? 8 : 0.35 * Math.min(v2 - l, t2 - p2);
        d.beginPath();
        d.moveTo(l, p2);
        d.save();
        d.fillStyle = A2;
        ...
        d.globalAlpha = 1;
        0 < D && (L2 = 0 === D % 2 ? 0 : 0.5, d.beginPath(), d.lineWidth = D, d.strokeStyle = H2, d.moveTo(l, p2), d.rect(l - L2, p2 - L2, v2 - l + 2 * L2, t2 - p2 + 2 * L2), d.stroke());
        d.restore();
        true === T2 && (d.save(), d.beginPath(), d.moveTo(l, p2), d.lineTo(l + J2, p2 + J2), d.lineTo(v2 - J2, p2 + J2), d.lineTo(v2, p2), d.closePath(), D = d.createLinearGradient((v2 + l) / 2, p2 + J2, (v2 + l) / 2, p2), D.addColorStop(0, A2), D.addColorStop(1, "rgba(255, 255, 255, .4)"), d.fillStyle = D, d.fill(), d.restore());
        ...
        true === O2 && (d.save(), d.beginPath(), d.moveTo(l, p2), d.lineTo(l + J2, p2 + J2), d.lineTo(l + J2, t2 - J2), d.lineTo(l, t2), d.closePath(), D = d.createLinearGradient(l + J2, (t2 + p2) / 2, l, (t2 + p2) / 2), D.addColorStop(0, A2), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), d.fillStyle = D, d.fill(), d.restore());
        true === R2 && (d.save(), d.beginPath(), d.moveTo(
          v2,
          p2
        ), d.lineTo(v2 - J2, p2 + J2), d.lineTo(v2 - J2, t2 - J2), d.lineTo(v2, t2), D = d.createLinearGradient(v2 - J2, (t2 + p2) / 2, v2, (t2 + p2) / 2), D.addColorStop(0, A2), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), d.fillStyle = D, D.addColorStop(0, A2), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), d.fillStyle = D, d.fill(), d.closePath(), d.restore());
      }, ja = function(d) {
      ...
      ka.prototype._wrapText = function() {
        ...
        if (0 === this.frontSize)
          ...
          for (; 0 < d.length; ) {
            ...
            H2 && t2 > H2 && (D = p2.pop(), t2 -= D.height, A2 = J2);
          }
      ...
      t = Ra.Chart = function() {
        ...
        function A2(a, g, c, b, e, h, r, x, I, k) {
          ...
          a.beginPath();
          I && 0 < x.thickness ? (a.moveTo(b - r.thickness / 2, Math.round((c + e) / 2) - q), a.lineTo(g + r.thickness / 2, Math.round((c + e) / 2) - q)) : 0 < x.thickness && (a.moveTo(Math.round((g + b) / 2) - q, c + r.thickness / 2), a.lineTo(Math.round((g + b) / 2) - q, e - r.thickness / 2));
          a.stroke();
        ...
        l.prototype._processMultiseriesPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = false, r = 0; r < a.dataSeriesIndexes.length; r++) {
              var x = this.data[a.dataSeriesIndexes[r]], I = 0, k = false, m = false, q;
        ...
        l.prototype._processStackedPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = false, r = [], x = [], I = Infinity, k = -Infinity, m = {}, q = 0; q < a.dataSeriesIndexes.length; q++) {
              ...
              for (f = 0; f < n.dataPoints.length; f++) {
                ...
                if (b < s && !d2)
                  ...
                  b < c.viewPortMin && (c.viewPortMin = b);
                  b > c.viewPortMax && (c.viewPortMax = b);
                  null === n.dataPoints[f].y ? c.viewPortMin === b && y < b && (c.viewPortMin = y) : (m[b] = (m[b] || 0) + n.dataPoints[f].y, n.dataPointEOs[f].cumulativeY = m[b], a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? r[b] ? r[b] += e : (r[b] = e, I = Math.min(e, I)) : x[b] ? x[b] += e : (x[b] = e, k = Math.max(e, k)));
                }
              }
            ...
            for (var g = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = false, r = false, x = false, I = {}, k = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
              ...
              for (n = 0; n < q.dataPoints.length; n++) {
                ...
                if (b < y && !f)
                  ...
                  b < c.viewPortMin && (c.viewPortMin = b);
                  b > c.viewPortMax && (c.viewPortMax = b);
                  null === e ? c.viewPortMin === b && w < b && (c.viewPortMin = w) : (I[b] = (I[b] || 0) + q.dataPoints[n].y, q.dataPointEOs[n].cumulativeY = I[b], a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? r = true : 0 > e && (x = true), k[b] = k[b] ? k[b] + Math.abs(e) : Math.abs(e));
                }
              }
              q.axisX.valueType = q.xValueType = h ? "dateTime" : "number";
            }
            a.axisY.logarithmic ? (g.max = p(g.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(g.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), g.min = p(g.viewPortMin) ? 1 : Math.min(g.viewPortMin, 1)) : r && !x ? (g.max = p(g.viewPortMax) ? 99 : Math.max(g.viewPortMax, 99), g.min = p(g.viewPortMin) ? 1 : Math.min(g.viewPortMin, 1)) : r && x ? (g.max = p(g.viewPortMax) ? 99 : Math.max(g.viewPortMax, 99), g.min = p(g.viewPortMin) ? -99 : Math.min(g.viewPortMin, -99)) : !r && x && (g.max = p(g.viewPortMax) ? -1 : Math.max(
              g.viewPortMax,
              -1
            ), g.min = p(g.viewPortMin) ? -99 : Math.min(g.viewPortMin, -99));
            g.viewPortMin = g.min;
            g.viewPortMax = g.max;
            a.dataPointYSums = k;
          }
                ...
                for (var f2 = a2.axisY.dataInfo, g2 = a2.axisX.dataInfo, h2, r2 = g2.min, k2 = g2.max, m2 = f2.min, q2 = f2.max, g2 = g2._dataRanges, f2 = f2._dataRanges, n2, x2 = 0, d3 = 0; d3 < a2.dataSeriesIndexes.length; d3++) {
                  ...
                  if (!(4 > I.dataPoints.length)) {
                    for (x2 = 0; x2 < I.dataPoints.length; x2++)
                      if (b2 && (n2 = (k2 + 1 - r2) * Math.max(parseFloat(a2.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h2 = I.dataPoints[x2].x.getTime ? I.dataPoints[x2].x.getTime() : I.dataPoints[x2].x, n2 = Math.floor((h2 - r2) / n2), h2 < g2[n2].min && (g2[n2].min = h2), h2 > g2[n2].max && (g2[n2].max = h2)), c2) {
              ...
              if (this._lastTouchData.scroll && this.zoomEnabled)
                ...
                for (c = 0; c < g.length; c++)
                  if (e = g[c], r = document.createEvent("MouseEvent"), r.initMouseEvent(
                    ...
                    0,
                    null
                  ), b.target.dispatchEvent(r), !p(this._lastTouchData.scroll) && !this._lastTouchData.scroll || !this._lastTouchData.scroll && 250 < h || "click" === e)
        ...
        l.prototype.renderIndexLabels = function(a) {
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
            var m = this._indexLabels[a], q = m.chartType.toLowerCase(), n, f, x = na(
              "indexLabelFontColor",
              m.dataPoint,
              m.dataSeries
            ...
            if (null !== B && "" !== B) {
              ...
              "vertical" === l2 && (f += k - w._lineHeight / 2, 0 <= "ohlc candlestick boxandwhisker column rangecolumn stackedcolumn stackedcolumn100 error".split(" ").indexOf(q) && (A3 = 0 < t3 ? f + ("horizontal" === l2 ? k - w._lineHeight / 2 : 0) > m.point.y : f - ("horizontal" === l2 ? w._lineHeight / 2 : k) < m.point.y), "bubble" === q || "scatter" === q) && (n += w._lineHeight / 2 - Sa / 2);
              w.x = n;
              w.y = f;
              w.render(true);
              ...
              if (0 < p2.length) {
                for (var l2 = 5 < q && f.bevelEnabled ? true : false, h = 0; h < p2.length; h++)
                  if (p2[h].getTime ? d2 = p2[h].x.getTime() : d2 = p2[h].x, !(d2 < a.axisX.dataInfo.viewPortMin || d2 > a.axisX.dataInfo.viewPortMax) && "number" === typeof p2[h].y) {
                    ...
                    ba(c, a.axisX.reversed ? y : r, x, a.axisX.reversed ? r : y, s, b, 0, null, l2 && (a.axisY.reversed ? 0 > p2[h].y : 0 <= p2[h].y), (a.axisY.reversed ? 0 <= p2[h].y : 0 > p2[h].y) && l2, false, false, f.fillOpacity);
                    b = f.dataPointIds[h];
                ...
                for (var z = 5 < p2 && y.bevelEnabled ? true : false, k = 0; k < s.length; k++)
                  if (b = s[k].x.getTime ? s[k].x.getTime() : s[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[k].y) {
                    ...
                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < s[k].y) {
                      ...
                      B = "undefined" !== typeof r[b] ? r[b] : 0, E = q + B, q = n + B, a.dataSeriesIndexes.length - 1 === f && 1 >= Math.abs(e.y2 - E) && (E = e.y2), r[b] = B + (E - q);
                    b = s[k].color ? s[k].color : y._colorSet[k % y._colorSet.length];
                    ba(c, m, a.axisY.reversed ? E : q, u, a.axisY.reversed ? q : E, b, 0, null, z && (a.axisY.reversed ? 0 > s[k].y : 0 <= s[k].y), (a.axisY.reversed ? 0 <= s[k].y : 0 > s[k].y) && z, false, false, y.fillOpacity);
                    b = y.dataPointIds[k];
                    this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: l2, dataPointIndex: k, x1: m, y1: q, x2: u, y2: E };
        ...
        l.prototype.renderBar = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip());
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
              var n = a.dataSeriesIndexes[m], f = this.data[n], l2 = f.dataPoints;
              if (0 < l2.length) {
                ...
                for (var fa = true; w < l2.length; w++)
                  if (z = l2[w].x.getTime ? l2[w].x.getTime() : l2[w].x, !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax && (!f.connectNullData || !fa)))
                    if ("number" !== typeof l2[w].y)
                      ...
                      0 !== l2[w].markerSize && (0 < l2[w].markerSize || 0 < f.markerSize) && (z = f.getMarkerProperties(w, y, s, h), p2.push(z), aa = O(aa), v && p2.push({ x: y, y: s, ctx: r, type: z.type, size: z.size, color: aa, borderColor: aa, borderThickness: z.borderThickness }));
                ...
                for (l2 = false; n < q.length; n++)
                  if (f = q[n].x.getTime ? q[n].x.getTime() : q[n].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !l2)))
                    if ("number" !== typeof q[n].y)
                      ...
                      var K = m.dataPointIds[n];
                      this._eventManager.objectMap[K] = { id: K, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: n, x1: f, y1: l2 };
                      z[z.length] = { x: f, y: l2 };
                      ...
                      if (0 !== q[n].markerSize && (0 < q[n].markerSize || 0 < m.markerSize)) {
                        var U = m.getMarkerProperties(n, f, l2, b);
                        r.push(U);
                        K = O(K);
                        v && r.push({ x: f, y: l2, ctx: e, type: U.type, size: U.size, color: K, borderColor: K, borderThickness: U.borderThickness });
                      }
                      (q[n].indexLabel || m.indexLabel || q[n].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "splineArea", dataPoint: q[n], dataSeries: m, point: { x: f, y: l2 }, direction: 0 > q[n].y === a.axisY.reversed ? 1 : -1, color: u });
                      l2 = false;
                    }
                g();
                Y.drawMarkers(r);
                ...
                for (; w < l2.length; w++)
                  if (z = l2[w].x.getTime ? l2[w].x.getTime() : l2[w].x, !(z < a.axisX.dataInfo.viewPortMin || z > a.axisX.dataInfo.viewPortMax && (!f.connectNullData || !c))) {
                    ...
                    "number" !== typeof l2[w].y ? (f.connectNullData || (c || g) || b(), c = true) : (y = a.axisX.convertValueToPixel(z), s = a.axisY.convertValueToPixel(l2[w].y), g || c ? (!g && f.connectNullData ? (h.setLineDash && (f.options.nullDataLineDashType || K === f.lineDashType && f.lineDashType !== f.nullDataLineDashType) && (g = y, c = s, y = m.x, s = m.y, b(), h.moveTo(m.x, m.y), y = g, s = c, B = m, K = f.nullDataLineDashType, h.setLineDash(U)), h.lineTo(y, aa), h.lineTo(y, s), v && (r.lineTo(y, aa), r.lineTo(y, s))) : (h.beginPath(), h.moveTo(y, s), v && (r.beginPath(), r.moveTo(y, s)), B = { x: y, y: s }), c = g = false) : (h.lineTo(y, aa), v && r.lineTo(
                      y,
                      aa
                    ), h.lineTo(y, s), v && r.lineTo(y, s), 0 == w % 250 && b()), m = { x: y, y: s }, w < l2.length - 1 && (A3 !== (l2[w].lineColor || t3) || K !== (l2[w].lineDashType || f.lineDashType)) && (b(), A3 = l2[w].lineColor || t3, h.strokeStyle = A3, h.setLineDash && (l2[w].lineDashType ? (K = l2[w].lineDashType, h.setLineDash(H(K, f.lineThickness))) : (K = f.lineDashType, h.setLineDash(D2)))), z = f.dataPointIds[w], this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: w, x1: y, y1: s }, 0 !== l2[w].markerSize && (0 < l2[w].markerSize || 0 < f.markerSize) && (aa = f.getMarkerProperties(w, y, s, h), p2.push(aa), z = O(z), v && p2.push({ x: y, y: s, ctx: r, type: aa.type, size: aa.size, color: z, borderColor: z, borderThickness: aa.borderThickness })), (l2[w].indexLabel || f.indexLabel || l2[w].indexLabelFormatter || f.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepArea", dataPoint: l2[w], dataSeries: f, point: { x: y, y: s }, direction: 0 > l2[w].y === a.axisY.reversed ? 1 : -1, color: C }));
                  }
                b();
                Y.drawMarkers(p2);
              }
                ...
                for (var aa = true, n = 0; n < m.length; n++) {
                  ...
                  if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa)))
                    if ("number" !== typeof ha.y)
                      ...
                      k.push({ x: f, y: w - pa });
                      p2[h] = w - l2;
                      z || aa ? (!z && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || u === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (z = k.pop(), u = k[k.length - 1], g(), b.moveTo(s.x, s.y), k.push(u), k.push(z), u = C.nullDataLineDashType, b.setLineDash(U)), b.lineTo(f, l2), v && y.lineTo(f, l2)) : (b.beginPath(), b.moveTo(f, l2), v && (y.beginPath(), y.moveTo(f, l2))), aa = z = false) : (b.lineTo(f, l2), v && y.lineTo(f, l2), 0 == n % 250 && (g(), b.moveTo(f, l2), v && y.moveTo(f, l2), k.push({ x: f, y: w - pa })));
                      s = { x: f, y: l2 };
                      n < t3.length - 1 && (K !== (t3[n].lineColor || A3) || u !== (t3[n].lineDashType || C.lineDashType)) && (g(), b.beginPath(), b.moveTo(f, l2), k.push({ x: f, y: w - pa }), K = t3[n].lineColor || A3, b.strokeStyle = K, b.setLineDash && (t3[n].lineDashType ? (u = t3[n].lineDashType, b.setLineDash(H(u, C.lineThickness))) : (u = C.lineDashType, b.setLineDash(D2))));
        ...
        l.prototype.renderStackedArea100 = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (t3 = 0; t3 < a.dataSeriesIndexes.length; t3++) {
              ...
              k = [];
              if (0 < m.length) {
                var e = C._colorSet[n % C._colorSet.length], D2 = C.lineColor = C.options.lineColor || e, K = D2;
                b.fillStyle = e;
                b.strokeStyle = D2;
                b.lineWidth = C.lineThickness;
                s = "solid";
                  ...
                  if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa)))
                    if ("number" !== typeof ha.y)
                      ...
                      y || aa ? (!y && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || s === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (y = k.pop(), s = k[k.length - 1], g(), b.moveTo(w.x, w.y), k.push(s), k.push(y), s = C.nullDataLineDashType, b.setLineDash(U)), b.lineTo(f, l2), v && u.lineTo(f, l2)) : (b.beginPath(), b.moveTo(f, l2), v && (u.beginPath(), u.moveTo(
                        f,
                        l2
                      ))), aa = y = false) : (b.lineTo(f, l2), v && u.lineTo(f, l2), 0 == n % 250 && (g(), b.moveTo(f, l2), v && u.moveTo(f, l2), k.push({ x: f, y: z - la })));
                      w = { x: f, y: l2 };
                      n < A3.length - 1 && (K !== (A3[n].lineColor || D2) || s !== (A3[n].lineDashType || C.lineDashType)) && (g(), b.beginPath(), b.moveTo(f, l2), k.push({ x: f, y: z - la }), K = A3[n].lineColor || D2, b.strokeStyle = K, b.setLineDash && (A3[n].lineDashType ? (s = A3[n].lineDashType, b.setLineDash(H(s, C.lineThickness))) : (s = C.lineDashType, b.setLineDash(fa))));
                      if (0 <= C.dataPointIndexes[h]) {
              ...
              if (0 < m.length) {
                ...
                for (var q = 0, n = 0, e = 0; e < m.length; e++)
                  if (h = m[e].getTime ? h = m[e].x.getTime() : h = m[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                    ...
                    c.globalAlpha = 1;
                    Math.sqrt((q - h) * (q - h) + (n - r) * (n - r)) < Math.min(f.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (q = k.dataPointIds[e], this._eventManager.objectMap[q] = { id: q, objectType: "dataPoint", dataSeriesIndex: p2, dataPointIndex: e, x1: h, y1: r }, q = O(q), v && Y.drawMarker(f.x, f.y, this._eventManager.ghostCtx, f.type, f.size, q, q, f.borderThickness), (m[e].indexLabel || k.indexLabel || m[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "scatter", dataPoint: m[e], dataSeries: k, point: { x: h, y: r }, direction: 1, bounds: { x1: h - f.size / 2, y1: r - f.size / 2, x2: h + f.size / 2, y2: r + f.size / 2 }, color: null }), q = h, n = r);
                  }
              }
            }
            v && (g.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.restore());
              ...
              if (0 < z.length) {
                for (var u = 5 < t3 && s.bevelEnabled ? true : false, d2 = 0; d2 < z.length; d2++)
                  if (z[d2].getTime ? f = z[d2].x.getTime() : f = z[d2].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !p(z[d2].y) && z[d2].y.length && "number" === typeof z[d2].y[0] && "number" === typeof z[d2].y[1] && "number" === typeof z[d2].y[2] && "number" === typeof z[d2].y[3]) {
                    ...
                    this._eventManager.objectMap[D2] = { id: D2, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: d2, x1: E, y1: k, x2: B, y2: m, x3: l2, y3: q, x4: l2, y4: n, borderThickness: C, color: e };
                    c.strokeStyle = e;
                    c.beginPath();
                    c.lineWidth = C;
                    b.lineWidth = Math.max(C, 4);
                    "candlestick" === s.type ? (c.moveTo(l2 - A3, m), c.lineTo(l2 - A3, Math.min(k, n)), c.stroke(), c.moveTo(l2 - A3, Math.max(k, n)), c.lineTo(l2 - A3, q), c.stroke(), ba(c, E, Math.min(k, n), B, Math.max(k, n), z[d2].y[0] <= z[d2].y[3] ? s.risingColor : h, C, e, u, u, false, false, s.fillOpacity), v && (e = O(D2), b.strokeStyle = e, b.moveTo(l2 - A3, m), b.lineTo(l2 - A3, Math.min(k, n)), b.stroke(), b.moveTo(l2 - A3, Math.max(k, n)), b.lineTo(l2 - A3, q), b.stroke(), ba(b, E, Math.min(k, n), B, Math.max(k, n), e, 0, null, false, false, false, false))) : "ohlc" === s.type && (c.moveTo(l2 - A3, m), c.lineTo(l2 - A3, q), c.stroke(), c.beginPath(), c.moveTo(l2, k), c.lineTo(E, k), c.stroke(), c.beginPath(), c.moveTo(l2, n), c.lineTo(B, n), c.stroke(), v && (e = O(D2), b.strokeStyle = e, b.moveTo(l2 - A3, m), b.lineTo(l2 - A3, q), b.stroke(), b.beginPath(), b.moveTo(l2, k), b.lineTo(E, k), b.stroke(), b.beginPath(), b.moveTo(l2, n), b.lineTo(B, n), b.stroke()));
                    (z[d2].indexLabel || s.indexLabel || z[d2].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({ chartType: s.type, dataPoint: z[d2], dataSeries: s, point: { x: E + (B - E) / 2, y: a.axisY.reversed ? q : m }, direction: 1, bounds: { x1: E, y1: Math.min(m, q), x2: B, y2: Math.max(m, q) }, color: e });
                  }
              }
            }
            v && (g.drawImage(
              ...
              if (0 < u.length) {
                for (var E = 5 < t3 && z.bevelEnabled ? true : false, r = 0; r < u.length; r++)
                  if (u[r].getTime ? f = u[r].x.getTime() : f = u[r].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && !p(u[r].y) && u[r].y.length && "number" === typeof u[r].y[0] && "number" === typeof u[r].y[1] && "number" === typeof u[r].y[2] && "number" === typeof u[r].y[3] && "number" === typeof u[r].y[4] && 5 === u[r].y.length) {
                    ...
                    var B = d2 - t3 / 2 << 0, C = d2 + t3 / 2 << 0, e = u[r].color ? u[r].color : z._colorSet[0], A3 = Math.round(Math.max(1, 0.15 * t3)), D2 = 0 === A3 % 2 ? 0 : 0.5, K = u[r].whiskerColor ? u[r].whiskerColor : u[r].color ? z.whiskerColor ? z.whiskerColor : u[r].color : z.whiskerColor ? z.whiskerColor : e, U = "number" === typeof u[r].whiskerThickness ? u[r].whiskerThickness : "number" === typeof z.options.whiskerThickness ? z.whiskerThickness : A3, fa = u[r].whiskerDashType ? u[r].whiskerDashType : z.whiskerDashType, aa = p(u[r].whiskerLength) ? p(z.options.whiskerLength) ? t3 : z.whiskerLength : u[r].whiskerLength, aa = "number" === typeof aa ? 0 >= aa ? 0 : aa >= t3 ? t3 : aa : "string" === typeof aa ? parseInt(aa) * t3 / 100 > t3 ? t3 : parseInt(aa) * t3 / 100 : t3, ha = 1 === Math.round(U) % 2 ? 0.5 : 0, pa = u[r].stemColor ? u[r].stemColor : u[r].color ? z.stemColor ? z.stemColor : u[r].color : z.stemColor ? z.stemColor : e, la = "number" === typeof u[r].stemThickness ? u[r].stemThickness : "number" === typeof z.options.stemThickness ? z.stemThickness : A3, F = 1 === Math.round(la) % 2 ? 0.5 : 0, J2 = u[r].stemDashType ? u[r].stemDashType : z.stemDashType, L2 = u[r].lineColor ? u[r].lineColor : u[r].color ? z.lineColor ? z.lineColor : u[r].color : z.lineColor ? z.lineColor : e, P2 = "number" === typeof u[r].lineThickness ? u[r].lineThickness : "number" === typeof z.options.lineThickness ? z.lineThickness : A3, R3 = u[r].lineDashType ? u[r].lineDashType : z.lineDashType, M = 1 === Math.round(P2) % 2 ? 0.5 : 0, T2 = z.upperBoxColor, S = z.lowerBoxColor, ua = p(z.options.fillOpacity) ? 1 : z.fillOpacity, Q = z.dataPointIds[r];
                    this._eventManager.objectMap[Q] = { id: Q, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: r, x1: B, y1: l2, x2: C, y2: k, x3: d2, y3: m, x4: d2, y4: q, y5: n, borderThickness: A3, color: e, stemThickness: la, stemColor: pa, whiskerThickness: U, whiskerLength: aa, whiskerColor: K, lineThickness: P2, lineColor: L2 };
                    c.save();
                    0 < la && (c.beginPath(), c.strokeStyle = pa, c.lineWidth = la, c.setLineDash && c.setLineDash(H(J2, la)), c.moveTo(d2 - F, k), c.lineTo(d2 - F, l2), c.stroke(), c.moveTo(d2 - F, q), c.lineTo(d2 - F, m), c.stroke());
                    c.restore();
                    b.lineWidth = Math.max(A3, 4);
                    c.beginPath();
                    ba(c, B, Math.min(n, k), C, Math.max(k, n), S, 0, e, w ? E : false, w ? false : E, false, false, ua);
                    c.beginPath();
                    ba(c, B, Math.min(m, n), C, Math.max(n, m), T2, 0, e, w ? false : E, w ? E : false, false, false, ua);
                    c.beginPath();
                    c.lineWidth = A3;
                    c.strokeStyle = e;
                    ...
                    0 < P2 && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(H(
                      R3,
                      P2
                    )), c.strokeStyle = L2, c.lineWidth = P2, c.moveTo(B, n - M), c.lineTo(C, n - M), c.stroke());
                    c.restore();
                    c.save();
                    0 < U && (c.beginPath(), c.setLineDash && c.setLineDash(H(fa, U)), c.strokeStyle = K, c.lineWidth = U, c.moveTo(d2 - aa / 2 << 0, q - ha), c.lineTo(d2 + aa / 2 << 0, q - ha), c.stroke(), c.moveTo(d2 - aa / 2 << 0, l2 + ha), c.lineTo(d2 + aa / 2 << 0, l2 + ha), c.stroke());
                    c.restore();
                    v && (e = O(Q), b.strokeStyle = e, b.lineWidth = la, 0 < la && (b.moveTo(d2 - D2 - F, k), b.lineTo(d2 - D2 - F, Math.max(l2, q)), b.stroke(), b.moveTo(d2 - D2 - F, Math.min(l2, q)), b.lineTo(d2 - D2 - F, m), b.stroke()), ba(b, B, Math.max(
                      k,
                      m
                    ), C, Math.min(k, m), e, 0, null, false, false, false, false), 0 < U && (b.beginPath(), b.lineWidth = U, b.moveTo(d2 + aa / 2, q - ha), b.lineTo(d2 - aa / 2, q - ha), b.stroke(), b.moveTo(d2 + aa / 2, l2 + ha), b.lineTo(d2 - aa / 2, l2 + ha), b.stroke()));
                ...
                for (var t3 = 5 < k && n.bevelEnabled ? true : false, h = 0; h < f.length; h++)
                  if (f[h].getTime ? l2 = f[h].x.getTime() : l2 = f[h].x, !(l2 < a.axisX.dataInfo.viewPortMin || l2 > a.axisX.dataInfo.viewPortMax) && !p(f[h].y) && f[h].y.length && "number" === typeof f[h].y[0] && "number" === typeof f[h].y[1]) {
                    ...
                    if (f[h].indexLabel || n.indexLabel || f[h].indexLabelFormatter || n.indexLabelFormatter)
                      this._indexLabels.push({ chartType: "rangeColumn", dataPoint: f[h], dataSeries: n, indexKeyword: 0, point: { x: w + (y - w) / 2, y: f[h].y[1] >= f[h].y[0] ? d2 : r }, direction: f[h].y[1] >= f[h].y[0] ? -1 : 1, bounds: { x1: w, y1: Math.min(
                        r,
                        d2
                      ), x2: y, y2: Math.max(r, d2) }, color: b }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: f[h], dataSeries: n, indexKeyword: 1, point: { x: w + (y - w) / 2, y: f[h].y[1] >= f[h].y[0] ? r : d2 }, direction: f[h].y[1] >= f[h].y[0] ? 1 : -1, bounds: { x1: w, y1: Math.min(r, d2), x2: y, y2: Math.max(r, d2) }, color: b });
                  }
              }
            }
            ...
            for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
              ...
              if (0 < B.length)
                for (var H2 = E._colorSet, d2 = 0; d2 < B.length; d2++) {
                  var e = E.lineColor = E.options.color ? E.options.color : H2[0], K = { color: B[d2].whiskerColor ? B[d2].whiskerColor : B[d2].color ? E.whiskerColor ? E.whiskerColor : B[d2].color : E.whiskerColor ? E.whiskerColor : e, thickness: p(B[d2].whiskerThickness) ? E.whiskerThickness : B[d2].whiskerThickness, dashType: B[d2].whiskerDashType ? B[d2].whiskerDashType : E.whiskerDashType, length: p(B[d2].whiskerLength) ? p(E.options.whiskerLength) ? s : E.options.whiskerLength : B[d2].whiskerLength, trimLength: p(B[d2].whiskerLength) ? p(E.options.whiskerLength) ? 50 : 0 : 0 };
                  ...
                  if (!(t3 < a.axisX.dataInfo.viewPortMin || t3 > a.axisX.dataInfo.viewPortMax) && !p(B[d2].y) && B[d2].y.length && "number" === typeof B[d2].y[0] && "number" === typeof B[d2].y[1]) {
                    ...
                    b ? q = fa : f = fa;
                    b ? (n = a.axisX.reversed ? k + (C ? y : 1) * s / 2 - (C ? D2 - 1 : 0) * s << 0 : k - (C ? y : 1) * s / 2 + (C ? D2 - 1 : 0) * s << 0, f = a.axisX.reversed ? n - s << 0 : n + s << 0) : (m = a.axisX.reversed ? l2 + (C ? y : 1) * s / 2 - (C ? D2 - 1 : 0) * s << 0 : l2 - (C ? y : 1) * s / 2 + (C ? D2 - 1 : 0) * s << 0, q = a.axisX.reversed ? m - s << 0 : m + s << 0);
                    !b && n > f && (fa = n, n = f, f = fa);
                    b && m > q && (fa = m, m = q, q = fa);
                    fa = E.dataPointIds[d2];
                    this._eventManager.objectMap[fa] = { id: fa, objectType: "dataPoint", dataSeriesIndex: u, dataPointIndex: d2, x1: Math.min(m, q), y1: Math.min(n, f), x2: Math.max(q, m), y2: Math.max(f, n), isXYSwapped: b, stemProperties: U, whiskerProperties: K };
                    A2(c, Math.min(m, q), Math.min(n, f), Math.max(q, m), Math.max(f, n), e, K, U, b);
                    v && A2(this._eventManager.ghostCtx, m, n, q, f, e, K, U, b);
                    if (B[d2].indexLabel || E.indexLabel || B[d2].indexLabelFormatter || E.indexLabelFormatter)
                      this._indexLabels.push({ chartType: "error", dataPoint: B[d2], dataSeries: E, indexKeyword: 0, point: { x: b ? B[d2].y[1] >= B[d2].y[0] ? m : q : m + (q - m) / 2, y: b ? n + (f - n) / 2 : B[d2].y[1] >= B[d2].y[0] ? f : n }, direction: B[d2].y[1] >= B[d2].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(m, q) : m, y1: b ? n : Math.min(n, f), x2: b ? Math.max(m, q) : q, y2: b ? f : Math.max(n, f) }, color: e, axisSwapped: b }), this._indexLabels.push({ chartType: "error", dataPoint: B[d2], dataSeries: E, indexKeyword: 1, point: { x: b ? B[d2].y[1] >= B[d2].y[0] ? q : m : m + (q - m) / 2, y: b ? n + (f - n) / 2 : B[d2].y[1] >= B[d2].y[0] ? n : f }, direction: B[d2].y[1] >= B[d2].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(m, q) : m, y1: b ? n : Math.min(n, f), x2: b ? Math.max(m, q) : q, y2: b ? f : Math.max(n, f) }, color: e, axisSwapped: b });
                  }
                }
            }
            v && (g.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d2 = 0; d2 < a.dataSeriesIndexes.length; d2++) {
              ...
              if (0 < q.length) {
                ...
                for (var K = true; f < q.length; f++)
                  if (s = q[f].x.getTime ? q[f].x.getTime() : q[f].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !K)))
                  ...
                  if (n = m[q].x.getTime ? m[q].x.getTime() : m[q].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !f)))
                    if (null !== m[q].y && m[q].y.length && "number" === typeof m[q].y[0] && "number" === typeof m[q].y[1]) {
                      ...
                      if (0 !== m[q].markerSize && (0 < m[q].markerSize || 0 < k.markerSize)) {
                        ...
                        h.push(D2);
                        var K = O(A3);
                        v && h.push({ x: n, y: f, ctx: e, type: D2.type, size: D2.size, color: K, borderColor: K, borderThickness: D2.borderThickness });
                        D2 = k.getMarkerProperties(q, n, l2, b);
                        h.push(D2);
                        K = O(A3);
                        v && h.push({ x: n, y: l2, ctx: e, type: D2.type, size: D2.size, color: K, borderColor: K, borderThickness: D2.borderThickness });
                      }
                      if (m[q].indexLabel || k.indexLabel || m[q].indexLabelFormatter || k.indexLabelFormatter)
                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[q], dataSeries: k, indexKeyword: 0, point: { x: n, y: f }, direction: m[q].y[0] <= m[q].y[1] ? -1 : 1, color: s }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[q], dataSeries: k, indexKeyword: 1, point: { x: n, y: l2 }, direction: m[q].y[0] <= m[q].y[1] ? 1 : -1, color: s });
                      f = false;
                    } else
                      0 < q && !f && (k.connectNullData ? b.setLineDash && (0 < w.length && (k.options.nullDataLineDashType || !m[q - 1].lineDashType)) && (w[w.length - 1].newLineDashArray = C, E = k.nullDataLineDashType) : (g(B, z), w = [], y = [])), f = true;
                g(B, z);
                Y.drawMarkers(h);
              }
            }
              ...
              if (0 < y.length)
                for (var u = 5 < n && w.bevelEnabled ? true : false, t3 = false, B = null, C = null, r = 0; r < y.length; r++)
                  if (y[r].getTime ? m = y[r].x.getTime() : m = y[r].x, "number" !== typeof y[r].y) {
                    ...
                    ba(c, a.axisX.reversed ? D2 : d2, a.axisY.reversed ? k : p2, a.axisX.reversed ? d2 : D2, a.axisY.reversed ? p2 : k, K, 0, K, u, u, false, false, w.fillOpacity);
                    e = O(e);
                    v && ba(this._eventManager.ghostCtx, a.axisX.reversed ? D2 : d2, p2, a.axisX.reversed ? d2 : D2, k, e, 0, null, false, false, false, false);
                    var U, K = d2;
                    U = "undefined" !== typeof y[r].isIntermediateSum && true === y[r].isIntermediateSum || "undefined" !== typeof y[r].isCumulativeSum && true === y[r].isCumulativeSum ? 0 < y[r].y ? p2 : k : 0 < y[r].y ? k : p2;
                    ...
                    (y[r].indexLabel || w.indexLabel || y[r].indexLabelFormatter || w.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: y[r], dataSeries: w, point: { x: d2 + (D2 - d2) / 2, y: 0 <= y[r].y ? p2 : k }, direction: 0 > y[r].y === a.axisY.reversed ? 1 : -1, bounds: { x1: d2, y1: Math.min(p2, k), x2: D2, y2: Math.max(p2, k) }, color: e });
                  }
            }
            v && (g.drawImage(
              this._preRenderCanvas,
        ...
        var ja2 = function(a, g, c, b, e, h, r, d2, p2) {
          if (!(0 > c)) {
            ...
            for (var c2 = a2 = 0, g2 = 0, d3 = true, c2 = 0; 10 > c2 && (1 > c2 || 0 < g2); c2++) {
              ...
              (function() {
                for (var a3 = -1, c3 = -1, g3 = 0, h2 = false, r3 = 0; r3 < m.length; r3++)
                  if (h2 = false, p2 = f[r3], p2.indexLabelText) {
                    var d4 = e(r3);
                    if (null !== d4) {
                      var k2 = f[d4];
                      t4 = 0;
                      ...
                      n2 ? (0 > a3 && (a3 = r3), d4 !== a3 && (c3 = d4, g3 += -t4), 0 === r3 % Math.max(m.length / 10, 3) && (h2 = true)) : h2 = true;
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            if (0 !== t3) {
              ...
              this.pieDoughnutClickHandler = function(a2) {
                l2.isAnimating || !p(this.explodeOnClick) && !this.explodeOnClick || (a2 = a2.dataPoint, a2.exploded = a2.exploded ? false : true, 1 < this.dataPoints.length && l2._animator.animate(0, 500, function(a3) {
                  c(a3, true);
                  d2();
        ...
        l.prototype.renderFunnel = function(a) {
          ...
          function c() {
            ...
            if (0 === h2)
              return -1;
            for (var d3 = g2[0] = 0, k2 = 0, m2, n2, b2 = b2 - a2, d3 = false, r2 = 0; r2 < z.length; r2++)
              a2 = Math.abs(z[r2].y) * f2 / h2, d3 ? m2 = 0 == Number(c2.toFixed(3)) ? 0 : a2 / c2 : (n2 = ca3 * ca3 * b2 * b2 - 4 * Math.abs(ca3) * a2, 0 > n2 ? (n2 = c2, d3 = (b2 + n2) * (e2 - k2) / 2, a2 -= d3, m2 = e2 - k2, k2 += e2 - k2, m2 += 0 == n2 ? 0 : a2 / n2, k2 += a2 / n2, d3 = true) : (m2 = (Math.abs(ca3) * b2 - Math.sqrt(n2)) / 2, n2 = b2 - 2 * m2 / Math.abs(ca3), k2 += m2, k2 > e2 && (k2 -= m2, n2 = c2, d3 = (b2 + n2) * (e2 - k2) / 2, a2 -= d3, m2 = e2 - k2, k2 += e2 - k2, m2 += a2 / n2, k2 += a2 / n2, d3 = true), b2 = n2)), g2.push(m2);
            return g2;
          }
          function b() {
            if (s && z) {
              for (var a2, b2, c2, e2, g2, h2, r2, d3, k2, m2, n2, q2, l3, x, u2, w2 = [], t4 = [], I = { percent: null, total: null }, B2 = null, A4 = 0; A4 < z.length; A4++)
              ...
              for (var A4 = 0, C2 = z.length - 1; A4 < z.length || 0 <= C2; A4++, C2--) {
                ...
                G.push({ textBlock: c2, id: s.reversed ? C2 : A4, isDirty: false, lineColor: a2, lineThickness: m2, lineDashType: n2, height: c2.height < c2.maxHeight ? c2.height : c2.maxHeight, width: c2.width < c2.maxWidth ? c2.width : c2.maxWidth });
              }
            }
          }
          function e() {
            ...
            for (var h2, r2 = L2 - Z2 - S / 2, r2 = s.options.indexLabelMaxWidth ? s.indexLabelMaxWidth > r2 ? r2 : s.indexLabelMaxWidth : r2, d3 = G.length - 1; 0 <= d3; d3--) {
              ...
              c2 = G[d3];
              e2 = c2.textBlock;
              b2 = (a2 = n(d3) < Q.length ? G[n(d3)] : null) ? a2.textBlock : null;
              c2 = c2.height;
          ...
          function r() {
            ...
            function b2() {
              ...
              for (var d3, k3 = 1; k3 < r3; k3++) {
                ...
                for (var p3 = G.length - 1; 0 <= p3; p3--)
                  !G[p3].isDirty && (G[p3].textBlock.y < g3 && G[p3].textBlock.y + G[p3].height > g3) && (d3 = n(p3), !(d3 >= G.length - 1) && G[p3].textBlock.y + G[p3].height + ea3 > G[d3].textBlock.y && (G[p3].textBlock.y = G[p3].textBlock.y + G[p3].height - g3 > g3 - G[p3].textBlock.y ? g3 + 1 : g3 - G[p3].height - 1));
              }
            ...
            for (var e2, g2, f2, h2, r2, k2, m2 = 1, p2 = 0; p2 < 2 * m2; p2++) {
              for (var l3 = G.length - 1; 0 <= l3 && !(0 <= q(l3) && q(l3), f2 = G[l3], h2 = f2.textBlock, k2 = (r2 = n(l3) < Q.length ? G[n(l3)] : null) ? r2.textBlock : null, e2 = +f2.height.toFixed(6), g2 = +h2.y.toFixed(6), !f2.isDirty && (r2 && g2 + e2 + ea3 > +k2.y.toFixed(6)) && (e2 = h2.y + e2 + ea3 - k2.y, g2 = a2(l3, -e2), g2 < e2 && (0 < g2 && (e2 -= g2), g2 = a2(n(l3), e2), g2 != e2))); l3--)
                ;
              b2();
            }
          }
          ...
          function l2(a2, b2, c2) {
            ...
            var p2 = { startTime: (/* @__PURE__ */ new Date()).getTime(), duration: c2 || 500, easingFunction: function(a3, b3, c3, e3) {
              ...
              for (var b3, c3, e3 = 0; e3 < Q.length; e3++)
                b3 = f2[e3], c3 = Q[e3], b3 *= a3, "undefined" === typeof n2[e3] && (n2[e3] = 0), 0 > n2 && (n2 *= -1), c3.y1 += b3 - n2[e3], c3.y2 += b3 - n2[e3], c3.y3 += b3 - n2[e3], c3.y4 += b3 - n2[e3], c3.y5 && (c3.y5 += b3 - n2[e3], c3.y6 += b3 - n2[e3]), n2[e3] = b3;
            } };
        ...
        l.prototype.replaceKeywordsWithValue = function(a, g, c, b, e) {
          ...
          if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            var r = "#percent", d2 = "#total", p2 = this.getPercentAndTotal(c, g), d2 = isNaN(p2.total) ? d2 : p2.total, r = isNaN(p2.percent) ? r : p2.percent;
            do {
              p2 = "";
        ...
        R2.prototype.setLayout = function() {
          var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, g = a.layoutManager.getFreeSpace(), c = null, b = 0, e = 0, h = 0, r = 0, d2 = this.markerMargin = this.chart.options.legend && !p(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
          this.height = 0;
          var l2 = [], k = [];
          ...
          for (var m = 0; m < this.dataSeries.length; m++) {
            ...
            if (q.dataPoints && q.dataPoints.length)
              if ("pie" !== q.type && "doughnut" !== q.type && "funnel" !== q.type && "pyramid" !== q.type) {
                var n = q.legendMarkerType = q.legendMarkerType ? q.legendMarkerType : "line" !== q.type && "stepLine" !== q.type && "spline" !== q.type && "scatter" !== q.type && "bubble" !== q.type || !q.markerType ? "error" === q.type && q._linkedSeries ? q._linkedSeries.legendMarkerType ? q._linkedSeries.legendMarkerType : W2.getDefaultLegendMarker(q._linkedSeries.type) : W2.getDefaultLegendMarker(q.type) : q.markerType, f = q.legendText ? q.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: q, dataPoint: null }) : q.name, v2 = q.legendMarkerColor = q.legendMarkerColor ? q.legendMarkerColor : q.markerColor ? q.markerColor : "error" === q.type ? p(q.whiskerColor) ? q._colorSet[0] : q.whiskerColor : q._colorSet[0], w = q.markerSize || "line" !== q.type && "stepLine" !== q.type && "spline" !== q.type ? 0.75 * this.lineHeight : 0, y = q.legendMarkerBorderColor ? q.legendMarkerBorderColor : q.markerBorderColor, s = q.legendMarkerBorderThickness ? q.legendMarkerBorderThickness : q.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0;
                ...
                n = { markerType: n, markerColor: v2, text: f, textBlock: null, chartType: q.type, markerSize: w, lineColor: q._colorSet[0], dataSeriesIndex: q.index, dataPointIndex: null, markerBorderColor: y, markerBorderThickness: s };
                l2.push(n);
              } else
                for (var z = 0; z < q.dataPoints.length; z++) {
                  var u = q.dataPoints[z], n = u.legendMarkerType ? u.legendMarkerType : q.legendMarkerType ? q.legendMarkerType : W2.getDefaultLegendMarker(q.type), f = u.legendText ? u.legendText : q.legendText ? q.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                    chart: this.chart,
                    legend: this.options,
                    dataSeries: q,
                    dataPoint: u
                  }) : u.name ? u.name : "DataPoint: " + (z + 1), v2 = u.legendMarkerColor ? u.legendMarkerColor : q.legendMarkerColor ? q.legendMarkerColor : u.color ? u.color : q.color ? q.color : q._colorSet[z % q._colorSet.length], w = 0.75 * this.lineHeight, y = u.legendMarkerBorderColor ? u.legendMarkerBorderColor : q.legendMarkerBorderColor ? q.legendMarkerBorderColor : u.markerBorderColor ? u.markerBorderColor : q.markerBorderColor, s = u.legendMarkerBorderThickness ? u.legendMarkerBorderThickness : q.legendMarkerBorderThickness ? q.legendMarkerBorderThickness : u.markerBorderThickness || q.markerBorderThickness ? Math.max(1, Math.round(0.2 * w)) : 0, f = this.chart.replaceKeywordsWithValue(f, u, q, z), n = { markerType: n, markerColor: v2, text: f, textBlock: null, chartType: q.type, markerSize: w, dataSeriesIndex: m, dataPointIndex: z, markerBorderColor: y, markerBorderThickness: s };
        ...
        R2.prototype.render = function() {
          ...
          for (var d2 = 0, p2 = 0; p2 < r.length; p2++) {
            for (var k = r[p2], m = 0, q = 0; q < k.items.length; q++) {
              var n = k.items[q], f = n.textBlock.x + a + (0 === q ? 0.2 * h : this.horizontalSpacing), l2 = g + d2, w = f;
              ...
              if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
                this.ctx.strokeStyle = n.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(f - 0.1 * this.lineHeight, l2 + this.lineHeight / 2), this.ctx.lineTo(f + 0.85 * this.lineHeight, l2 + this.lineHeight / 2), this.ctx.stroke(), w -= 0.1 * this.lineHeight;
              ...
              Y.drawMarker(f + h / 2, l2 + this.lineHeight / 2, this.ctx, n.markerType, "error" === n.chartType || "line" === n.chartType || "spline" === n.chartType ? n.markerSize / 2 : n.markerSize, n.markerColor, n.markerBorderColor, n.markerBorderThickness);
              n.textBlock.x = f + c + h;
              if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
        ...
        D.prototype.createLabels = function() {
          ...
          if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
            ...
            for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Za(new Date(this.viewportMaximum), this.interval, this.intervalType), f = n, c = this.intervalStartPosition; c < e; Za(c, b, this.intervalType)) {
          ...
          if (this.labelAutoFit || this.options.labelAutoFit) {
            if (p(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
              ...
              if (h = p(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, d2 = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                ...
                for (p(this.chart.stockChart) || this.chart.isNavigator || (this.sessionVariables.labelMaxHeight = d2), c = 0; c < this._labels.length; c++)
                  a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = p(this.options.labelMaxWidth) ? p(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = h : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = p(this.options.labelFontSize) ? p(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = p(this.options.labelAngle) ? p(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = p(this.options.labelWrap) ? p(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = p(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = d2 : this.sessionVariables.labelMaxHeight, a.measureText();
          }
        ...
        D.setLayout = function(a, g, c, b, e, h) {
          ...
          for (var y = w = 0, s = 0, z = 0, u = 0, A3 = 0, B = 0, C, D2, H2 = l2 = 0, K, J2, L2, v2 = K = J2 = L2 = false, f = 0; f < n.length; f++)
          ...
          if ("normal" === e) {
            for (var z = [], u = [], A3 = [], B = [], N2 = [], P2 = [], O2 = [], R3 = []; 4 > w; ) {
              ...
              if (a && 0 < a.length)
                for (f = 0; f < a.length; f++)
                  a[f] && (a[f].lineCoordinates.x1 = d2, t3 = Math.round(h.x2 - $ - Z2 > m.width - q ? m.width - q : h.x2 - $ - Z2), a[f]._labels && 1 < a[f]._labels.length && (l2 = k = 0, k = a[f]._labels[1], l2 = "dateTime" === a[f].valueType ? a[f]._labels[a[f]._labels.length - 2] : a[f]._labels[a[f]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - l2.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), s = l2.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l2.textBlock.angle)) + (l2.textBlock.height - l2.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l2.textBlock.angle))), !a[f] || (!a[f].labelAutoFit || p(C) || p(D2) || m.isNavigator || m.stockChart) || (l2 = 0, 0 < a[f].labelAngle ? D2 + s > t3 && (l2 += 0 < a[f].labelAngle ? D2 + s - t3 - $ : 0) : 0 > a[f].labelAngle ? C - y < d2 && C - y < a[f].viewportMinimum && (H2 = d2 - (M + a[f].tickLength + A3 + C - y + a[f].labelFontSize / 2)) : 0 === a[f].labelAngle && (D2 + s > t3 && (l2 = D2 + s / 2 - t3 - $), C - y < d2 && C - y < a[f].viewportMinimum && (H2 = d2 - M - a[f].tickLength - A3 - C + y / 2)), a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 < a[f].labelAngle && 0 < l2 ? t3 -= l2 : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 > a[f].labelAngle && 0 < H2 ? d2 += H2 : a[f].viewportMaximum === a[f].maximum && a[f].viewportMinimum === a[f].minimum && 0 === a[f].labelAngle && (0 < H2 && (d2 += H2), 0 < l2 && (t3 -= l2))), m.panEnabled ? X3 = p(m.sessionVariables.axisX.height) || m.stockChart ? m.sessionVariables.axisX.height = X3 : m.sessionVariables.axisX.height : m.sessionVariables.axisX.height = X3, l2 = Math.round(h.y2 - X3 - e + F), k = Math.round(h.y2), a[f].lineCoordinates.x2 = t3, a[f].lineCoordinates.width = t3 - d2, a[f].lineCoordinates.y1 = l2, a[f].lineCoordinates.y2 = l2, "inside" === a[f].labelPlacement && 0 < f && (a[f].lineCoordinates.y1 = a[f - 1].lineCoordinates.y2 + F + (a[f].labelEffectiveHeight || 0), a[f].lineCoordinates.y2 = a[f].lineCoordinates.y1 + a[f].lineThickness / 2), "inside" === a[f].tickPlacement && 0 < f && (a[f].lineCoordinates.y1 += a[f].tickLength, a[f].lineCoordinates.y2 = a[f].lineCoordinates.y1 + a[f].lineThickness / 2), a[f].bounds = { x1: d2, y1: l2, x2: t3, y2: k - (X3 + e - z[f] - F), width: t3 - d2 }, a[f].bounds.height = a[f].bounds.y2 - a[f].bounds.y1), F += z[f] + a[f].margin;
              if (g && 0 < g.length)
                for (f = 0; f < g.length; f++)
                  g[f].lineCoordinates.x1 = Math.round(h.x1 + Q + M), g[f].lineCoordinates.x2 = Math.round(h.x2 - $ - Z2 > m.width - q ? m.width - q : h.x2 - $ - Z2), g[f].lineCoordinates.width = Math.abs(t3 - d2), g[f]._labels && 1 < g[f]._labels.length && (k = g[f]._labels[1], l2 = "dateTime" === g[f].valueType ? g[f]._labels[g[f]._labels.length - 2] : g[f]._labels[g[f]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - l2.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), s = l2.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l2.textBlock.angle)) + (l2.textBlock.height - l2.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l2.textBlock.angle))), m.panEnabled ? Y2 = p(m.sessionVariables.axisX2.height) || m.stockChart ? m.sessionVariables.axisX2.height = Y2 : m.sessionVariables.axisX2.height : m.sessionVariables.axisX2.height = Y2, l2 = Math.round(h.y1), k = g[f].lineCoordinates.y1 = l2 + Y2 + W3 - T2, g[f].lineCoordinates.y2 = l2, "inside" === g[f].labelPlacement && 0 < f && (g[f].lineCoordinates.y1 = g[f - 1].lineCoordinates.y1 - T2 - (g[f].labelEffectiveHeight || 0)), "inside" === g[f].tickPlacement && 0 < f && (g[f].lineCoordinates.y1 -= g[f].tickLength), g[f].bounds = { x1: d2, y1: l2 + (Y2 + W3 - u[f] - T2), x2: t3, y2: k, width: t3 - d2 }, g[f].bounds.height = g[f].bounds.y2 - g[f].bounds.y1, T2 += u[f] + g[f].margin;
              if (c && 0 < c.length)
                for (f = 0; f < c.length; f++)
                  M = m.isNavigator ? 0 : 10, c[f] && (d2 = Math.round(a[0] ? a[0].lineCoordinates.x1 : g[0].lineCoordinates.x1), M = c[f]._labels && 0 < c[f]._labels.length ? c[f]._labels[c[f]._labels.length - 1].textBlock.height / 2 : q, l2 = Math.round(h.y1 + Y2 + W3 < Math.max(M, q) ? Math.max(M, q) : h.y1 + Y2 + W3), t3 = Math.round(a[0] ? a[0].lineCoordinates.x1 : g[0].lineCoordinates.x1), M = 0 < a.length ? 0 : c[f]._labels && 0 < c[f]._labels.length ? c[f]._labels[0].textBlock.height / 2 : q, k = Math.round(h.y2 - X3 - e - M), c[f].lineCoordinates = { x1: d2 - S, y1: l2, x2: t3 - S, y2: k, height: Math.abs(k - l2) }, "inside" === c[f].labelPlacement && 0 < f && (c[f].lineCoordinates.x1 = c[f - 1].lineCoordinates.x1 - S - (c[f].labelEffectiveWidth || 0), c[f].lineCoordinates.x2 = c[f].lineCoordinates.x1 + c[f].lineThickness / 2), "inside" === c[f].tickPlacement && 0 < f && (c[f].lineCoordinates.x1 -= c[f].tickLength, c[f].lineCoordinates.x2 = c[f].lineCoordinates.x1 + c[f].lineThickness / 2), c[f].bounds = { x1: d2 - (A3[f] + S), y1: l2, x2: t3 - S, y2: k, height: k - l2 }, c[f].bounds.width = c[f].bounds.x2 - c[f].bounds.x1, c[f].title && (c[f]._titleTextBlock.maxWidth = 0 < c[f].titleMaxWidth && c[f].titleMaxWidth < c[f].lineCoordinates.height ? c[f].titleMaxWidth : c[f].lineCoordinates.height), S += A3[f] + c[f].margin);
              if (b && 0 < b.length)
                for (f = 0; f < b.length; f++)
                  b[f] && (d2 = Math.round(a[0] ? a[0].lineCoordinates.x2 : g[0].lineCoordinates.x2), t3 = Math.round(d2), M = b[f]._labels && 0 < b[f]._labels.length ? b[f]._labels[b[f]._labels.length - 1].textBlock.height / 2 : 0, l2 = Math.round(h.y1 + Y2 + W3 < Math.max(M, q) ? Math.max(M, q) : h.y1 + Y2 + W3), M = 0 < a.length ? 0 : b[f]._labels && 0 < b[f]._labels.length ? b[f]._labels[0].textBlock.height / 2 : 0, k = Math.round(h.y2 - (X3 + e + M)), b[f].lineCoordinates = {
                    x1: d2 + V,
                    y1: l2,
                    x2: d2 + V,
                    y2: k,
            ...
            for (P2 = []; 4 > w; ) {
              ...
              if (c && 0 < c.length)
                for (f = 0; f < c.length; f++)
                  c[f].lineCoordinates = {}, d2 = Math.round(h.x1 + V + e), t3 = Math.round(h.x2 - X3 - W3 > m.width - 10 ? m.width - 10 : h.x2 - X3 - W3), c[f].labelAutoFit && !p(z) && (0 < !a.length && (d2 = 0 > c[f].labelAngle ? Math.max(d2, z) : 0 === c[f].labelAngle ? Math.max(d2, z / 2) : d2), 0 < !g.length && (t3 = 0 < c[f].labelAngle ? t3 - u / 2 : 0 === c[f].labelAngle ? t3 - u / 2 : t3)), c[f].lineCoordinates.x1 = d2, c[f].lineCoordinates.x2 = t3, c[f].lineCoordinates.width = Math.abs(t3 - d2), c[f].title && (c[f]._titleTextBlock.maxWidth = 0 < c[f].titleMaxWidth && c[f].titleMaxWidth < c[f].lineCoordinates.width ? c[f].titleMaxWidth : c[f].lineCoordinates.width);
              if (b && 0 < b.length)
                for (f = 0; f < b.length; f++)
                  b[f].lineCoordinates = {}, d2 = Math.round(h.x1 + V + e), t3 = Math.round(h.x2 - X3 - W3 > b[f].chart.width - 10 ? b[f].chart.width - 10 : h.x2 - X3 - W3), b[f] && b[f].labelAutoFit && !p(A3) && (0 < !a.length && (d2 = 0 < b[f].labelAngle ? Math.max(d2, A3) : 0 === b[f].labelAngle ? Math.max(d2, A3 / 2) : d2), 0 < !g.length && (t3 -= B / 2)), b[f].lineCoordinates.x1 = d2, b[f].lineCoordinates.x2 = t3, b[f].lineCoordinates.width = Math.abs(t3 - d2), b[f].title && (b[f]._titleTextBlock.maxWidth = 0 < b[f].titleMaxWidth && b[f].titleMaxWidth < b[f].lineCoordinates.width ? b[f].titleMaxWidth : b[f].lineCoordinates.width);
              if (c && 0 < c.length)
                for (q = [], f = S = 0; f < c.length; f++)
                  q.push(Math.ceil(c[f] ? c[f].createLabelsAndCalculateHeight() : 0)), S += q[f] + c[f].margin, M += c[f].margin;
              else
        ...
        D.prototype.calculateBreaksSizeInValues = function() {
          for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, g = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !p(this.scaleBreaks.options.spacing), e, h = 0; h < g.length; h++)
            e = b || !p(g[h].options.spacing), g[h].spacing = Va(g[h].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0, g[h].size = 0 > g[h].spacing ? 0 : Math.abs(g[h].spacing / c), this.logarithmic && (g[h].size = Math.pow(
              this.logarithmBase,
              g[h].size
            ));
        };
        ...
        D.prototype.showCrosshair = function(a) {
          p(a) || (a < this.viewportMinimum || a > this.viewportMaximum) || ("top" === this._position || "bottom" === this._position ? this.crosshair.render(this.convertValueToPixel(a), null, a) : this.crosshair.render(
            null,
        ...
        P.prototype.render = function() {
          ...
          if (0 < g) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position)
              ...
              l2 = p2 = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, d2 = this.chart.plotArea.x2, this.bounds = {
                x1: e,
                y1: l2 - g / 2,
                x2: d2,
                y2: p2 + g / 2
            ...
            if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
              ...
              if ("bottom" === this.parent._position || "top" === this.parent._position) {
                if ("rangeBar" === u.dataSeries.type || "error" === u.dataSeries.type) {
                  ...
                  "stackedBar" === u.dataSeries.type ? (w = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), cumulativeY = u.dataSeries.dataPointEOs[u.index].cumulativeY, t3 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(cumulativeY) << 0) + 0.5 : this.parent.convertValueToPixel(cumulativeY) << 0, this.value = cumulativeY, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: cumulativeY }) : p(this.options.label) ? ga(p(c) ? cumulativeY : c, this.valueFormatString, this.chart._cultureInfo) : this.label) : "stackedBar100" === u.dataSeries.type ? (w = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y)), cumulativeY = u.dataSeries.dataPointEOs[u.index].cumulativeY, z = u.dataPoint.x.getTime ? u.dataPoint.x.getTime() : u.dataPoint.x, yPercent = 100 * (cumulativeY / u.dataSeries.plotUnit.dataPointYSums[z]), t3 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(yPercent) << 0) + 0.5 : this.parent.convertValueToPixel(yPercent) << 0, this.value = yPercent, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: yPercent }) : p(this.options.label) ? ga(
                    p(c) ? yPercent : c,
                    this.valueFormatString,
                    this.chart._cultureInfo
                  ) : this.label) : (t3 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(u.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(u.dataPoint.y) << 0, this.value = u.dataPoint.y, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: u.dataPoint.y }) : p(this.options.label) ? ga(p(c) ? u.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label);
                b = e = t3;
              ...
              if ("rangeColumn" === u.dataSeries.type || "rangeArea" === u.dataSeries.type || "error" === u.dataSeries.type || "rangeSplineArea" === u.dataSeries.type || "candlestick" === u.dataSeries.type || "ohlc" === u.dataSeries.type || "boxAndWhisker" === u.dataSeries.type) {
                ...
                "stackedColumn" === u.dataSeries.type ? (b = u.dataSeries.dataPointEOs[u.index].cumulativeY, v2 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                  ...
                  value: b
                }) : p(this.options.label) ? ga(p(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "stackedArea" === u.dataSeries.type ? (b = u.dataSeries.dataPointEOs[u.index].cumulativeY, v2 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b }) : p(this.options.label) ? ga(p(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "stackedColumn100" === u.dataSeries.type ? (v2 = u.dataSeries.dataPointEOs[u.index].cumulativeY, z = u.dataPoint.x.getTime ? u.dataPoint.x.getTime() : u.dataPoint.x, b = 100 * (v2 / u.dataSeries.plotUnit.dataPointYSums[z]), v2 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: b }) : p(this.options.label) ? ga(p(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "stackedArea100" === u.dataSeries.type ? (v2 = u.dataSeries.dataPointEOs[u.index].cumulativeY, z = u.dataPoint.x.getTime ? u.dataPoint.x.getTime() : u.dataPoint.x, b = 100 * (v2 / u.dataSeries.plotUnit.dataPointYSums[z]), v2 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(b) << 0) + 0.5 : this.parent.convertValueToPixel(b) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                  chart: this.chart,
                  axis: this.parent.options,
                  crosshair: this.options,
                  value: b
                }) : p(this.options.label) ? ga(p(c) ? b : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = b) : "waterfall" === u.dataSeries.type ? (v2 = 1 === f.lineWidth % 2 ? (this.parent.convertValueToPixel(u.dataSeries.dataPointEOs[u.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(u.dataSeries.dataPointEOs[u.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: u.dataSeries.dataPointEOs[u.index].cumulativeSum }) : p(this.options.label) ? ga(p(c) ? u.dataSeries.dataPointEOs[u.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = u.dataSeries.dataPointEOs[u.index].cumulativeSum) : (v2 = 1 === f.lineWidth % 2 ? (p(a) ? g : this.parent.convertValueToPixel(u.dataPoint.y) << 0) + 0.5 : p(a) ? g : this.parent.convertValueToPixel(u.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: p(c) ? u.dataPoint.y : c }) : p(this.options.label) ? ga(p(c) ? u.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = u.dataPoint.y);
              d2 = l2 = v2;
              b = this.chart.plotArea.x1;
              e = this.chart.plotArea.x2;
              this.bounds = { x1: b, y1: d2 - n / 2, x2: e, y2: l2 + n / 2 };
            ...
            if ("xySwapped" === this.chart.plotInfo.axisPlacement)
              if ("left" === this.parent._position || "right" === this.parent._position) {
                ...
                if (s) {
                  ...
                  k.text = "dateTime" !== this.parent.valueType || this.parent.logarithmic ? this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: p(c) ? this.parent.convertPixelToValue(g) : c }) : p(this.options.label) ? ga(p(c) ? this.parent.convertPixelToValue(g) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: p(c) ? this.parent.convertPixelToValue(g) : c }) : p(this.options.label) ? Da(p(c) ? this.parent.convertPixelToValue(g) : c, this.valueFormatString, this.chart._cultureInfo) : this.label;
              ...
              k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: p(c) ? this.parent.convertPixelToValue(g) : c }) : p(this.options.label) ? ga(p(c) ? this.parent.convertPixelToValue(g) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.y = g + k.fontSize / 2 - k.measureText().height / 2 + 2, k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2), "left" === this.parent._position ? k.x = this.parent.lineCoordinates.x2 - k.measureText().width : "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2);
        ...
        oa.prototype.showAtX = function(a, d2) {
          ...
          if (this.shared)
            for (var l2 = 0; l2 < this.chart.data.length; l2++)
              c = this.chart.data[l2], (b = c.getDataPointAtX(a, false)) && (b.dataPoint && !p(b.dataPoint.y) && c.visible) && (b.dataSeries = c, this.chart.data[d2].axisX.convertValueToPixel(a) === c.axisX.convertValueToPixel(b.dataPoint.x) && h.push(b));
          else
